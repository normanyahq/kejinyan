        ...
        init: function(c) {
            return this.each(function() {
                ...
                if (f.itemTemplate == false) {
                    d.queueItem = b('<div class="uploadifive-queue-item">                                             <div><span class="filename"></span><span class="fileinfo"></span></div>                        <div class="progress">                            <div class="progress-bar"></div>                        </div>                    </div>');
                } else {
                ...
                d.removeQueueItem = function(m, l, k) {
                    ...
                    var j = l ? 0 : 500;
                    if (m.queueItem) {
                        if (m.queueItem.find(".fileinfo").html() != " - 上传完毕") {
                            m.queueItem.find(".fileinfo").html(" - 上传取消");
                        }
                ...
                d.uploadComplete = function(l, j, k) {
                    if (b.inArray("onUploadComplete", f.overrideEvents) < 0) {
                        ...
                        j.queueItem.find(".fileinfo").html(" - 上传完毕");
