...
for i in range(0,1):
    ...
    grayscale_image = cv2.imread('/Users/Norman/git/Answer-Sheet-OCR/ocr/data/new_full.jpg'.format(i), cv2.IMREAD_GRAYSCALE)
    ...
    binary_image, centers, original_image = adjustOrientation(binary_image, grayscale_image, 'tmp/detect_{}.jpg'.format(i))
    ...
    print recognizeJPG('/Users/Norman/git/Answer-Sheet-OCR/ocr/data/new_full.jpg', 'full')
